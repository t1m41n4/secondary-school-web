...
export default function ArchiveVideoFeature() {
  ...
  return (
    <div className="bg-gray-900 rounded-xl overflow-hidden shadow-xl relative group">
      <div className="aspect-video relative">
        ...
        <div className={`absolute inset-0 bg-black/50 flex flex-col items-center justify-center transition-opacity duration-300 ${isPlaying ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
          <h3 className="text-white text-xl sm:text-2xl font-bold mb-2">Archive Aerial View</h3>
          <p className="text-white/80 text-sm sm:text-base text-center max-w-md px-4">
            See how our school looked before recent construction and development
          </p>
        </div>
      ...
      <div className="absolute top-3 right-3 bg-primary text-white text-xs px-2 py-1 rounded-full animate-pulse">
        Archive Footage
      </div>
    </div>
  )
