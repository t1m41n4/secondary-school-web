...
const categoryData = {
  achievements: {
    title: "Achievements",
    description: "Stories of our school's and teachers' accomplishments",
    articles: [
      {
  ...
  "student-achievements": {
    ...
    description: "Celebrating our students' successes and innovations",
    articles: [
      {
  ...
  partnerships: {
    title: "Partnerships",
    description: "Organizations and institutions supporting our school",
    articles: [
      {
  ...
  "educational-resources": {
    ...
    description: "Learning materials for students in English and Swahili",
    articles: [
      {
        id: "study-tips-kcse",
      ...
      },
      {
        ...
        excerpt:
          "Strategies and resources to help students improve their understanding and performance in mathematics.",
  ...
  "school-life": {
    title: "School Life",
    description: "Day-to-day activities and events at Keriko Secondary",
    articles: [
      {
        id: "sports-day-2023",
...
export async function generateMetadata({ params }: { params: { category: string } }) {
  ...
  if (!data) {
    return {
      title: "Category Not Found | Keriko Secondary School Blog",
      description: "The requested category could not be found.",
    }
  }

  return {
    title: `${data.title} | Keriko Secondary School Blog`,
  ...
  return (
    <main>
      ...
      <section className="relative h-[40vh] flex items-center justify-center">
        ...
        <Image src="/images/category-hero.jpg" alt={data.title} fill className="object-cover" priority />
        <div className="relative z-20 text-center px-4">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4">{data.title}</h1>
